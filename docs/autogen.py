...
eywa_dir = pathlib.Path(__file__).resolve().parents[1]
...
def generate(sources_dir):
    ...
    readme = read_file(os.path.join(str(eywa_dir), 'README.md'))
    ...
    shutil.copyfile(os.path.join(str(eywa_dir), 'README.md'),
                    os.path.join(str(sources_dir), 'index.md'))
    copy_examples(os.path.join(str(eywa_dir), 'examples'),
                  os.path.join(str(sources_dir), 'examples'))


if __name__ == '__main__':
    generate(os.path.join(str(eywa_dir), 'docs', 'sources'))
